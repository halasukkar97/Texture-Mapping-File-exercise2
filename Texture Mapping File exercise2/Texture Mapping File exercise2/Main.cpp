...
HRESULT InitialiseGraphics()//03-01
{
	...
	POS_COL_TEX_VERTEX vertices[] =
	{
		...
		{ XMFLOAT3(-1.0f, 1.0f, -1.0f),XMFLOAT4(1.0f, 0.0f, 0.0f, 1.0f)  ,XMFLOAT2(1.0f,1.0f) },
		// right face
		{XMFLOAT3(1.0f, -1.0f, 1.0f),XMFLOAT4(1.0f, 0.70f, 0.40f, 1.0f)   ,XMFLOAT2(0.0f,0.0f) },
		{ XMFLOAT3(1.0f, -1.0f, -1.0f),XMFLOAT4(1.0f, 0.70f, 0.40f, 1.0f) ,XMFLOAT2(0.0f,1.0f) },
		{ XMFLOAT3(1.0f, 1.0f, -1.0f),XMFLOAT4(1.0f, 0.70f, 0.40f, 1.0f)  ,XMFLOAT2(1.0f,1.0f) },

		{ XMFLOAT3(1.0f, 1.0f, 1.0f),XMFLOAT4(1.0f, 0.70f, 0.40f, 1.0f)   ,XMFLOAT2(1.0f,0.0f) },
		{ XMFLOAT3(1.0f, -1.0f, 1.0f),XMFLOAT4(1.0f, 0.70f, 0.40f, 1.0f)  ,XMFLOAT2(0.0f,0.0f) },
		{ XMFLOAT3(1.0f, 1.0f, -1.0f),XMFLOAT4(1.0f, 0.70f, 0.40f, 1.0f)  ,XMFLOAT2(1.0f,1.0f) },

		// bottom face
		{XMFLOAT3(1.0f, -1.0f, -1.0f),XMFLOAT4(0.20f, 0.30f, 0.40f, 1.0f)   ,XMFLOAT2(1.0f,1.0f) },
		{ XMFLOAT3(1.0f, -1.0f, 1.0f),XMFLOAT4(0.20f, 0.30f, 0.40f, 1.0f)   ,XMFLOAT2(1.0f,0.0f) },
		{ XMFLOAT3(-1.0f, -1.0f, -1.0f),XMFLOAT4(0.20f, 0.30f, 0.40f, 1.0f) ,XMFLOAT2(0.0f,1.0f) },

		{ XMFLOAT3(1.0f, -1.0f, 1.0f),XMFLOAT4(0.20f, 0.30f, 0.40f, 1.0f)   ,XMFLOAT2(1.0f,0.0f) },
		{ XMFLOAT3(-1.0f, -1.0f, 1.0f),XMFLOAT4(0.20f, 0.30f, 0.40f, 1.0f)  ,XMFLOAT2(0.0f,0.0f) },
		{ XMFLOAT3(-1.0f, -1.0f, -1.0f),XMFLOAT4(0.20f, 0.30f, 0.40f, 1.0f) ,XMFLOAT2(0.0f,1.0f) },

		// top face
		{XMFLOAT3(1.0f, 1.0f, 1.0f),XMFLOAT4(-1.0f, -1.0f,0.30f, 1.0f)    ,XMFLOAT2(1.0f,0.0f) },
		{ XMFLOAT3(1.0f, 1.0f, -1.0f),XMFLOAT4(-1.0f, -1.0f,0.30f, 1.0f)  ,XMFLOAT2(1.0f,1.0f) },
		{ XMFLOAT3(-1.0f, 1.0f, -1.0f),XMFLOAT4(-1.0f, -1.0f,0.30f, 1.0f) ,XMFLOAT2(0.0f,1.0f) },

		{ XMFLOAT3(-1.0f, 1.0f, 1.0f),XMFLOAT4(-1.0f, -1.0f,0.30f, 1.0f)  ,XMFLOAT2(0.0f,0.0f) },
		{ XMFLOAT3(1.0f, 1.0f, 1.0f),XMFLOAT4(-1.0f, -1.0f,0.30f, 1.0f)   ,XMFLOAT2(1.0f,0.0f) },
		{ XMFLOAT3(-1.0f, 1.0f, -1.0f),XMFLOAT4(-1.0f, -1.0f,0.30f, 1.0f) ,XMFLOAT2(0.0f,1.0f) },
...
void RenderFrame(void)
{
	...
	//adding a text to the screen for score or time or messages and in case i have more then one i add the messages in renderframe and in case i got only one 
	//i add it to inisilasegraphics()
	g_2DText->AddText("yay me", -1.0,-0.7, .2);
